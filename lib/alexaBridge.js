    ...
    var reply = { 
      ...
      "response": {
        "outputSpeech": {
          ...
          "ssml": "<speak>Would you like to make a payment?</speak>"
        },
        "reprompt": {
          "outputSpeech": {
            "type": "PlainText",
            "text": "Can I help you with anything else?"  // provides the prompt phrase if the user doesn't ask another question after the first answer is send to them
          }
        },
